          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-center text-xs leading-relaxed text-muted-foreground">
              {minutes === 15
                ...
                : minutes === 25
                  // Было «классический фокус-блок, не выматывает» — конкретное
                  // утверждение об эффекте, которое никто на своих данных не
                  // проверял (независимый аудит отметил как недоказанный claim,
                  // тот же класс проблемы, что и снятая цифра NN/g ~18%).
                  ? '25 — весомый блок, но не марафон'
