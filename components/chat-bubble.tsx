...
/** Хвостик пузыря: оттяжка к говорящему, переходящая в тело кривой Безье.
    ...
    ГОРИЗОНТАЛЬНО, а не вниз, угол крепления — острая точка (радиус угла
    пузыря уже 0 — borderBottomLeftRadius ниже), не отдельное скругление.
    Один путь вместо двух фигур: у WhatsApp нет отдельной "фаски угла" —
    хвостик выходит прямо из острой точки (20,20) локальной вьюбокса. */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          d="M20 20 C13 20 5 18 0 15 C5 13 10 11 15 9 C17 8 19 9 20 10 Z"
          fill="var(--tail-fill)"
        />
        {warm && (
          <>
        ...
        <path
          d="M20 20 C13 20 5 18 0 15 C5 13 10 11 15 9 C17 8 19 9 20 10"
          fill="none"
