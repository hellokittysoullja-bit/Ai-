...
export function GreetingSkeleton() {
  ...
  // t-voice-hero (22px/28px) — родительская строка items-center на 64px
  // маскоте, так что здесь достаточно просто соответствовать высоте
  // строки, без своего смещения.
  return (
