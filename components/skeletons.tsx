...
export function GreetingSkeleton() {
  ...
  // подмене получилось бы два аватара подряд. Высота полос подогнана под
  // t-voice-hero (26px/32px) — родительская строка теперь items-center на
  // 84px маскоте, а не items-start с ручным pt-1, так что здесь достаточно
  // просто соответствовать высоте строки, без своего смещения.
  return (
