...
export function CompanionChat({
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      >
        {/* pb-24, не pb-6: композер ниже — sticky и перекрывает своим
            ...
            Этот комментарий уже требовал pb-24, а класс ниже реально несёт
            pb-6 — расхождение поймано внешней проверкой, не рендером: сам
            факт, что комментарий и код разошлись, и есть баг. */}
        <div className="mx-auto flex w-full max-w-md flex-col gap-3 px-4 pt-4 pb-24">
