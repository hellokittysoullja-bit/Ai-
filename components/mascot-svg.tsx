    ...
    >
      ...
      >
        ...
        <path
          ...
          strokeLinecap="round"
        />
        {/* Фитилёк: без него огонёк читается как отдельная левитирующая
            капля рядом с хвостом, а не пламя НА кончике хвоста — на
            увеличенном кадре между круглым концом хвоста и низом капли
            виден зазор. Маленький статичный (без боба вместе с огоньком)
            мостик того же цвета, что и хвост, закрывает его в любой фазе
            анимации огонька. */}
        <ellipse
          cx={182}
          cy={98}
