...
function buildFirstWord(
  ...
  if (isEvening) {
    return {
      // Короче прежней реплики: рядом появляется однотапов��я карточка
      ...
      <section className="border-b border-white/[0.06] bg-gradient-to-b from-card/55 via-card/15 to-transparent">
        ...
        <div className="mx-auto flex max-w-md flex-col gap-5 px-4 py-6">
          ...
          {/* S1 · Осязаемый контракт (уникальная механика Дома): договор на
              завтр�� — не строка в реплике, а карточка-артефакт с задачей,
                ...
                <>
                  ...
                  <span className="relative flex items-center gap-3.5">
                    <svg
                      ...
                      // brightness-150: SVG-ассеты ориентиров нарисова��ы
