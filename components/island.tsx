  ...
  return (
    ...
    <div className="mx-auto flex w-full max-w-md flex-col gap-6 px-4 pb-28 pt-6 md:my-auto md:max-w-lg">
      ...
      <button
        ...
        className="surface-card press cursor-pointer overflow-hidden rounded-3xl text-left focus-visible:ring-2 focus-visible:ring-ring"
      >
        <svg
          viewBox="0 0 380 216"
          role="img"
      ...
      {starts !== null && count === 0 && (
        <div className="surface-card flex flex-col gap-2 rounded-2xl p-5">
      ...
      {starts !== null && (
        <div className="surface-card flex flex-col gap-3 rounded-2xl p-4">
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center gap-1.5 rounded-xl border px-2 py-3 text-center ${
                    found ? 'border-reward/60 bg-reward/[0.06]' : 'border-white/12'
                  }`}
                >
      ...
      {starts !== null && count > 0 && (
        <ul className="flex flex-col gap-2">
          {recentDiary.map((entry) => (
            <li
              key={entry.id}
              className="surface-card flex items-start justify-between gap-3 rounded-xl px-4 py-3"
              style={
                entry.isNewToday
                  ? ({ borderColor: 'oklch(0.86 0.22 130 / 0.5)' } as CSSProperties)
                  : undefined
              }
            >
