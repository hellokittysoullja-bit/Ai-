...
export function AppBackdrop() {
  ...
  return (
    ...
    >
      ...
      {/* Плёночное зерно поверх всей сцены — тот же .grain, что уже держит
          hero лендинга (см. globals.css): большие плоские заливки ночного
          неба и очага без него читаются немного «пластиково», особенно на
          OLED. 2–3% шума — на грани восприятия, снимает эту стерильность,
          не добавляя видимого шума. Последним ребёнком, поверх всей сцены
          целиком, ни один другой слой сцены не задет. */}
