  ...
  return (
    ...
    >
      ...
      {/* #19 · СУЩЕСТВО У КОСТРА. Раньше напарник существовал только как
          ...
          Позиция выверена по факту в браузере: на 168px композер срезал
          силуэт до одних ушей, на 124px — накрывал целиком. 214px — первая
          высота, где фигура читается полностью между нижним пузырём и
          панелью ввода, у самой линии земли. */}
      <svg
        className="absolute bottom-[214px] left-[5%] h-auto w-[clamp(2.2rem,6vw,2.9rem)]"
        viewBox="0 0 40 44"
      >
