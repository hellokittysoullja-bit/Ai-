  ...
  return (
    ...
    >
      ...
      {/* луна с кратерами и дышащим гало.
          Позиция (546, 234) видима целиком при slice-кадрировании:
          - мобиль (горизонтальный кроп): visible x ~192–608 — луна ушла от правой
            кромки к центру-правее, больше не режется и не жмётся к хвосту;
          - десктоп (вертикальный кроп): visible y ~200–700 — cy держим > ~220. */}
      <circle cx="546" cy="234" r="110" fill="url(#hs-moon-glow)">
        <animate
      ...
      <g fill={INK} opacity="0.12">
        <circle cx="537" cy="225" r="6.2" />
        <circle cx="556" cy="242" r="4.2" />
        <circle cx="543" cy="248" r="2.7" />
      </g>
